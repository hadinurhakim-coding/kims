...
export function BottomPlayer({ onFavorite }: BottomPlayerProps) {
  ...
  return (
    <div
      className="fixed bottom-4 left-3 right-3 z-50 grid min-h-[120px] grid-cols-[minmax(0,1fr)_auto] items-center gap-3 rounded-[16px] border border-[rgba(255,255,255,0.3)] bg-[rgba(255,255,255,0.65)] px-3 py-3 shadow-[0_8px_32px_rgba(0,0,0,0.12)] md:left-6 md:right-6 md:grid-cols-[minmax(0,1fr)_minmax(280px,480px)_minmax(0,1fr)] md:px-5 lg:left-[268px] lg:right-[304px]"
      style={{
    ...
    >
      <div className="flex min-w-0 items-center gap-3">
        ...
        <button
          ...
          className={[
            "flex h-9 w-9 cursor-pointer items-center justify-center rounded-[var(--radius-full)] transition-all duration-150 hover:scale-110 hover:bg-[var(--color-background)] disabled:cursor-not-allowed disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-accent-primary)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-surface)]",
            isTrackFavorite
